...
public class SerialCOM {
    ...
    public void close() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "It wasn't possible close COM port.", "Error closing COM port", JOptionPane.PLAIN_MESSAGE);
        }
    }
    ...
    public void flushSerial() throws IOException {
        try {
            ...
            JOptionPane.showMessageDialog(null, "It wasn't possible flush COM port.", "Error", JOptionPane.PLAIN_MESSAGE);
        }
    }
