...
public class MainFrame extends javax.swing.JFrame {
    ...
    private boolean operational_mode, operational_control;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanelConnectionStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 310, 20, 20));
        ...
        getContentPane().add(jButtonConnect, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 100, 25));
        ...
        getContentPane().add(jButtonDisconnect, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 370, 100, 25));
        ...
        jComboBoxSerialCOM.setFont(new java.awt.Font("Ubuntu Medium", 0, 10)); // NOI18N
        jComboBoxSerialCOM.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "COM1", "COM2", "COM3", "COM4", "COM5", "COM6", "COM7", "COM8" }));
        jComboBoxSerialCOM.setSelectedIndex(7);
        jComboBoxSerialCOM.setOpaque(false);
        getContentPane().add(jComboBoxSerialCOM, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 340, 100, 25));
        ...
        getContentPane().add(jComboBoxBaudRate, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 370, 100, 25));
    ...
    private void getComPortID() {
        //if(operation_system = WINDOWS){
        //  com_port_id = "COM" + Integer.toString(jComboBoxSerialCOM.getSelectedIndex() + 1);
        //}
        //if(operation_system = LINUX){
        com_port_id = "/dev/ttyACM0";
        //}        
        //System.out.println("PortID = " + com_port_id);        
    }
    ...
    private void jButtonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConnectActionPerformed
        try {
            getComPortID();
            getBaudRate();
            arduino_UNO = new SerialCOM(com_port_id, baud_rate);
            ...
            JOptionPane.showMessageDialog(null, "COM could not be open.\n Verify SO type or cable", "Error opening COM", JOptionPane.PLAIN_MESSAGE);
        }
